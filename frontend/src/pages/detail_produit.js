...
const DetailProduit = () => {
    ...
    useEffect(() => {
        axios.get("https://studio-eventail.be:3001/produit", {params : {"id":id}, withCredentials: true }).then( res => {
    ...
    function modifier_produit(e){
        ...
        axios.post("https://studio-eventail.be:3001/produit", jsonToSend).catch(
