...
const Facture_devis = () => {
  ...
  const [message, setMessage] = useState("Madame, Monsieur,\r\nVeuillez trouver en pièce jointe votre facture / note de crédit.\r\nBien cordialement,\r\nStudio éventail.");
    ...
    useEffect(() => {
      axios.get("https://54.37.9.74:3001/facture_numero").then((res) => {
    ...
    function handleClientSelection(selectedClient) {
        axios.get("https://54.37.9.74:3001/detail_devis", {params : {"id": selectedClient.pk_devis_id}}).then((res) => {
            setDevis(res.data)
    ...
    function createFacture(e){
        ...
        axios.post("https://54.37.9.74:3001/nouvelle_facture", jsonToSend).catch(
