...
const Agenda = () => {
  ...
  useEffect(() => {
    ...
    let taches = []
    axios.get("https://studio-eventail.be:3001/agenda",{ params: { mois: monthNumber }, withCredentials: true  }).then((res) => {
      taches = res.data;
      axios.get("https://studio-eventail.be:3001/taches",{ params: { mois: monthNumber } , withCredentials: true }).then((res2) => {
  ...
  const prevMonth = () => {
    ...
    axios.get("https://studio-eventail.be:3001/agenda",{ params: { mois: prevMonthNumber }, withCredentials: true  }).then((res) => {
      let taches = res.data;
      axios.get("https://studio-eventail.be:3001/taches",{ params: { mois: prevMonthNumber }, withCredentials: true  }).then((res2) => {
        res2.data.forEach((tache)=>{
          taches.push(tache)
        })
        setActivities(taches);
  ...
  const nextMonth = () => {
    ...
    axios.get("https://studio-eventail.be:3001/agenda",{ params: { mois: nextMonthNumber }, withCredentials: true  }).then((res) => {
      let taches = res.data;
      axios.get("https://studio-eventail.be:3001/taches",{ params: { mois: nextMonthNumber }, withCredentials: true  }).then((res2) => {
        res2.data.forEach((tache)=>{
          taches.push(tache)
        })
        setActivities(taches);
