...
const Agenda = () => {
  ...
  useEffect(() => {
    ...
    let taches = []
    axios.get("https://54.37.9.74:3001/agenda", { params: { mois: monthNumber } }).then((res) => {
      taches = res.data;
      axios.get("https://54.37.9.74:3001/taches", { params: { mois: monthNumber } }).then((res2) => {
  ...
  const prevMonth = () => {
    ...
    axios.get("https://54.37.9.74:3001/agenda", { params: { mois: prevMonthNumber } }).then((res) => {
      let taches = res.data;
      axios.get("https://54.37.9.74:3001/taches", { params: { mois: prevMonthNumber } }).then((res2) => {
        res2.data.forEach((tache)=>{
          taches.push(tache)
        })
        setActivities(taches);
  ...
  const nextMonth = () => {
    ...
    axios.get("https://54.37.9.74:3001/agenda", { params: { mois: nextMonthNumber } }).then((res) => {
      let taches = res.data;
      axios.get("https://54.37.9.74:3001/taches", { params: { mois: nextMonthNumber } }).then((res2) => {
        res2.data.forEach((tache)=>{
          taches.push(tache)
        })
        setActivities(taches);
